...
PROTOBUF_NAMESPACE_OPEN
template<> ::wxz_rpc::header* Arena::CreateMaybeMessage<::wxz_rpc::header>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace wxz_rpc {
...
class header :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wxz_rpc.header) */ {
 public:
  header();
  virtual ~header();
  ...
  // @@protoc_insertion_point(class_scope:wxz_rpc.header)
 private:
  class _Internal;
...
inline const std::string& header::service_name() const {
  // @@protoc_insertion_point(field_get:wxz_rpc.header.service_name)
  return _internal_service_name();
}
inline void header::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:wxz_rpc.header.service_name)
}
inline std::string* header::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:wxz_rpc.header.service_name)
...
inline void header::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:wxz_rpc.header.service_name)
}
inline void header::set_service_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:wxz_rpc.header.service_name)
}
inline void header::set_service_name(const void* value, size_t size) {
  
  service_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:wxz_rpc.header.service_name)
}
...
inline std::string* header::release_service_name() {
  // @@protoc_insertion_point(field_release:wxz_rpc.header.service_name)
...
inline void header::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:wxz_rpc.header.service_name)
}
...
inline const std::string& header::method_name() const {
  // @@protoc_insertion_point(field_get:wxz_rpc.header.method_name)
  return _internal_method_name();
}
inline void header::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:wxz_rpc.header.method_name)
}
inline std::string* header::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:wxz_rpc.header.method_name)
...
inline void header::set_method_name(std::string&& value) {
  ...
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:wxz_rpc.header.method_name)
}
inline void header::set_method_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:wxz_rpc.header.method_name)
}
inline void header::set_method_name(const void* value, size_t size) {
  
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:wxz_rpc.header.method_name)
}
...
inline std::string* header::release_method_name() {
  // @@protoc_insertion_point(field_release:wxz_rpc.header.method_name)
...
inline void header::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:wxz_rpc.header.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 header::args_size() const {
  // @@protoc_insertion_point(field_get:wxz_rpc.header.args_size)
...
inline void header::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:wxz_rpc.header.args_size)
}
